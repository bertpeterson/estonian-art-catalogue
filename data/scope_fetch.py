...
todo=json.load(open('scope_todo.json',encoding='utf-8'))
...
def work(item):
    ...
    try:
        ...
        rec["artist_key"]=au; rec["artist"]=display(au)
...
json.dump(out,open('scope_records.json','w',encoding='utf-8'),ensure_ascii=False)
