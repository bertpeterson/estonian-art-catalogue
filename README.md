...
A browsable catalogue of **50,490 artworks** by **3,593 artists** — museum holdings from **24 Estonian public
...
| Haus, Kogo, Temnikova & Kasela, Tütar, Artrovert | 2,629 | Commercial galleries — current work, metadata only, no prices | Birthplace, dates, and art-historical affiliation for artists |
