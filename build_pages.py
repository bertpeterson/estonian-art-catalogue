...
for i, a in enumerate(A):
    ...
    doc = (f"<!doctype html><html lang=\"en\"><head><meta charset=\"utf-8\">"
           ...
           + neighbours(i)
           + f"<p class=\"m\">Museum records from MuIS and the EKM Digital Collection; gallery stock from the galleries' own catalogues; auction results as Haus Galerii, Vernissage and Allee galerii published them. "
